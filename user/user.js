...
function setupAdminLoginButton() {
    ...
    if (adminLoginBtn) {
        adminLoginBtn.addEventListener('click', () => {
            if (window.modalFunctions) {
                window.modalFunctions.closeAllModals();
                window.modalFunctions.openModal(window.modalFunctions.modals.adminLogin);
            }
        });
    }
}
...
function setupOpenAdminButton() {
    ...
    if (openAdminBtn) {
        openAdminBtn.addEventListener('click', () => {
            if (window.modalFunctions) {
                window.modalFunctions.closeAllModals();
                window.modalFunctions.openModal(document.getElementById('adminDashboardModal'));
            }
        });
    }
}
...
function setupMyOrdersButton() {
    ...
    if (myOrdersBtn) {
        myOrdersBtn.addEventListener('click', () => {
            ...
            if (window.modalFunctions) {
                window.modalFunctions.closeAllModals();
                window.modalFunctions.openModal(document.getElementById('myOrdersModal'));
            }
        });
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.userFunctions) {
        ...
        window.userFunctions.setupAdminLoginButton();
